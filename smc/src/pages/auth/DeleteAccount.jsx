  ...
  return (
    <Modal>
      <div className="w-[550px] min-h-[330px] my-4 mx-8 font-extralight font-poppins text-white">
        ...
        <p className="text-center text-xl">Delete Account</p>
        <p className=" text-justify my-6 lg:mx-8 md:mx-8 mx-1 font-extralight">
        ...
        <div className="flex justify-around mt-20 gap-1 flex-wrap ">
          ...
          <button
            className={` font-normal bg-white text-black text-center w-36 py-2.5 my-2 rounded-md`}
            onClick={() => handleDeleteCloseModal()}
          >
            Cancel
          </button>
